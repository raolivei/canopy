...
class Lot(Base):
    ...
    sold_price_per_unit: Mapped[Optional[Decimal]] = mapped_column(Numeric(precision=18, scale=8), nullable=True)
    sold_fees: Mapped[Optional[Decimal]] = mapped_column(Numeric(precision=18, scale=4), nullable=True)
