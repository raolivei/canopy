...
export default function SkeletonLoader({
  ...
  const baseClasses = 'animate-pulse bg-warm-gray-200 dark:bg-warm-gray-700 rounded';
  ...
  return (
    <div className="card p-6">
      <div className="flex items-center justify-between mb-4">
        ...
        <SkeletonLoader variant="rectangular" width={80} height={24} className="rounded-lg" />
      </div>
  ...
  return (
    <div className="card p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          <SkeletonLoader variant="text" width={120} height={24} className="mb-2" />
          <SkeletonLoader variant="text" width={80} height={16} />
        </div>
        <SkeletonLoader variant="rectangular" width={200} height={32} className="rounded-lg" />
      </div>
        ...
        <div key={i} className="p-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <SkeletonLoader variant="text" width={150} height={20} className="mb-2" />
                <SkeletonLoader variant="text" width={100} height={16} />
              </div>
            </div>
            <div className="text-right">
              <SkeletonLoader variant="text" width={80} height={20} className="mb-1" />
