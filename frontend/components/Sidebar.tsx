    ...
    <div className="fixed left-0 top-0 h-full w-64 bg-gradient-to-b from-gray-900 to-gray-800 dark:from-gray-950 dark:to-gray-900 text-white flex flex-col">
      <div className="p-6 border-b border-gray-700 dark:border-gray-800">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">Personal Finance</p>
          </div>
          <DarkModeToggle />
        </div>
      </div>
      ...
      <div className="p-4 border-t border-gray-700 dark:border-gray-800">
        <div className="bg-gray-800/50 dark:bg-gray-900/50 rounded-xl p-4">
          <p className="text-xs text-gray-400 dark:text-gray-500">Privacy First</p>
          <p className="text-sm text-gray-300 dark:text-gray-400 mt-1">All data stored locally</p>
        </div>
      </div>
    </div>
  )
